...
In short: If a repository has no license, then all rights are reserved and it is not Open Source or Free. You cannot modify or redistribute this code without explicit permission from the copyright holder. [Original Github Repo](https://github.com/remyc95/sv-scrum-board)
...
The web would have never existed in the first place without it being open-source, no body will know how to create websites in the first place, not ever your professors.
